...
ACTIONS = [
    ...
    {"id": 5, "name": "capacity_first", "F": 0.5, "CR": 0.75, "mutation_strategy": "rand_1", "repair_order": ["capacity", "link", "energy", "sink", "service", "deploy"], "power_policy": "balanced"},
    ...
    {"id": 7, "name": "throughput_priority", "F": 0.6, "CR": 0.85, "mutation_strategy": "best_1", "repair_order": ["link", "capacity", "energy", "sink", "service", "deploy"], "power_policy": "throughput_priority"},
