...
class Ctx:
    config = {"constraints": {"cv_pressure_refs": {"deploy": 1, "link": 2, "capacity": 4, "energy": 8, "sink": 16, "service": 32, "total": 64}}}
...
def test_cv_pressure_components_are_clipped_to_unit_interval():
    ...
    assert set(pressures) == {"deploy", "link", "capacity", "energy", "sink", "service", "total"}
